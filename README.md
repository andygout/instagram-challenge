...
- Generate migration: `$ bin/rails g migration AddRatingToPhotos rating:integer`
- Run migration: `$ bin/rake db:migrate`
...
- Add directory and file: `spec/support/database_cleaner.rb`; add to file code from [Virtuous Code - Configuring database_cleaner with Rails, RSpec, Capybara, and Selenium](http://devblog.avdi.org/2012/08/31/configuring-database_cleaner-with-rails-rspec-capybara-and-selenium/) or as included in this repo: [`spec/support/database_cleaner.rb`](https://github.com/andygout/instagram-challenge/blob/master/spec/support/database_cleaner.rb).
